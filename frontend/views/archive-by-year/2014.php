...
<section id="insidePhoto">
    <div class="container">
        <h2>Conference archive 2014</h2>

        <div class="tabs">
            <ul class="nav nav-tabs">
                <li><a href="#tab-1" data-toggle="tab" class="hvr-bubble-bottom"><i
                            class="fa fa-picture-o" aria-hidden="true"></i> PHOTOGALLERY</a></li>
                <li class="active"><a href="#tab-2" data-toggle="tab" class="hvr-bubble-bottom"><i class="fa fa-list-alt"
