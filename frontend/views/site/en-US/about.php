...
$this->title = 'About Conference | International Conference in Project, Program, and Portfolio Management';
?>
<div id="about-conf">
    <div class="organizers">
        <div class="container">
            ...
            <h3 class="wow fadeIn">ORGANIZING COMMITTEE</h3>

            <div class="item-group col-lg-6">
                <h3 class="wow fadeIn">Chairmen</h3>
            ...
            <div class="item-group col-lg-6">
                <h3 class="wow fadeIn">Co-Chairmen</h3>
            ...
            <div class="item-group col-lg-9">
                <h3 class="wow fadeIn" data-wow-delay="1.2s" data-offset="0">Organizing Committee Members</h3>
            ...
            <div class="item-group col-lg-3">
                <h3 class="wow fadeIn" data-wow-delay="1.2s" data-offset="0">Conference Manager</h3>
                ...
                <div class="col-lg-12 item hvr-float-shadow wow fadeInUp" data-wow-delay="1.8s" data-offset="0">
                    ...
                    <div class="txt-block">
                        ...
                        <hr>
                        <p class="proff"><i class="fa fa-graduation-cap"></i> Ph.D., Teaching Assistant, NTU "KhPI"</p>
    ...
    <div class="program-committee">
        <h3 class="wow fadeIn">PROGRAM COMMITTEE</h3>

        <div class="container">
            <div class="item-group col-lg-3">
                <h3 class="wow fadeIn" data-wow-delay="0.4s" data-offset="0">Chairman</h3>
