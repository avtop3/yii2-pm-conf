...
<div class="organizers">
    <div class="container">
        ...
        <h3 class="wow fadeIn">Организационный комитет</h3>

        <div class="item-group col-lg-6">
            <h3 class="wow fadeIn">Председатели</h3>
            ...
            <div class="col-lg-6 item hvr-float-shadow wow fadeInUp" data-wow-delay="0.4s" data-offset="0">
                ...
                <div class="txt-block">
                    ...
                    <hr>
                    <p class="proff"><i class="fa fa-graduation-cap" aria-hidden="true"></i> Д.т.н., профессор, ректор
                        НТУ «ХПИ», член-корреспондент НАНУ</p>
        ...
        <div class="item-group col-lg-6">
            <h3 class="wow fadeIn">Заместители председателей</h3>
            ...
            <div class="col-lg-6 item hvr-float-shadow wow fadeInUp" data-wow-delay="0.8s" data-offset="0">
                ...
                <div class="txt-block">
                    ...
                    <hr>
                    <p class="proff"><i class="fa fa-graduation-cap"></i>Д.т.н., профессор, проректор по научной работе
                        НТУ «ХПИ»</p>
        ...
        <div class="item-group col-lg-9">
            <h3 class="wow fadeIn" data-wow-delay="1.2s" data-offset="0">Члены организационного комитета</h3>
...
<div class="program-committee">
    <h3 class="wow fadeIn">Программный комитет</h3>
    ...
    <div class="container">
        ...
        <div class="item-group col-lg-9">
            <h3 class="wow fadeIn" data-wow-delay="0.4s" data-offset="0">Члены программного комитета</h3>
        ...
        <div class="item-group col-lg-12">
            ...
            <div class="col-lg-3 item hvr-float-shadow wow fadeInUp" data-wow-delay="1.2s" data-offset="0">
                ...
                <div class="txt-block">
                    ...
                    <hr>
                    <p class="proff"><i class="fa fa-graduation-cap"></i> Д.т.н., профессор, ННЦ «ИМЭСХ» НААН Украины
                    </p>
            ...
            <div class="col-lg-3 item hvr-float-shadow wow fadeInUp" data-wow-delay="1.8s" data-offset="0">
                ...
                <div class="txt-block">
                    ...
                    <hr>
                    <p class="proff"><i class="fa fa-graduation-cap"></i> Д.т.н., профессор, ГП НПКГ «Зоря»-«Машпроект»
                    </p>
...
<div class="location">
    <h3 class="wow fadeIn" data-wow-delay="0.4s" data-offset="0">Место проведения</h3>

    <div class="container">
        <p class="wow fadeIn" data-wow-delay="0.5s" data-offset="0">Отдых в Славске в гостинице «Жемчужина Карпат» — это
            незабываемые впечатления и заряд энергии. Гостиница работает с 1987 года. С тех пор мы сделали все, чтобы
            создать для наших гостей комфортные условия для отдыха в Карпатах с европейским уровнем обслуживания и
            искренним украинским гостепреимством.</p>

        <div class="img-block wow fadeInLeft" data-wow-delay="0.6s" data-offset="0">
            <img src="/markup/images/speakers/Basejn_21.jpg" alt="">
        </div>
        <p class="upper">Официальный сайт отеля - <a href="http://perlyna.com/" class="hvr-curl-top-right"><img
                    src="/markup/images/speakers/logo.png" alt=""></a></p>

        <p class="upper right">Отель на Booking.com - <a href="http://www.booking.com/hotel/ua/perlyna-karpat.ru.html"
                                                         class="hvr-curl-bottom-left"><img
                    src="/markup/images/speakers/booking.png" alt=""></a></p>
    </div>
</div>
<div class="map">
    <div class="container">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d10500.592991846172!2d23.4596944!3d48.8553834!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x657aa03c8943c2b4!2z0J_QtdGA0LvQuNC90LAg0JrQsNGA0L_QsNGC!5e0!3m2!1sru!2sua!4v1460196255381"
