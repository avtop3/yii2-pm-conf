...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 16, 2016 at 09:23 PM
...
INSERT INTO `member` (`id`, `name`, `nameEng`, `country`, `position`, `phone`, `email`, `interest`, `scienceDegree`, `scienceTitle`, `organisationTitle`, `organisationDepartment`, `organisationAddress`, `organisationActivity`, `participationType`, `topicTitle`, `topicLanguage`, `topicSection`, `created_at`, `updated_at`) VALUES
(5, 'Sulim', 'Alex Kovalchuk', 'af', 'Student', '0990062656', 'avtop@gmail.com', 'secret', '0', '0', 'NTU "HPI"', 'PM edu', 'sdfdf', '0', 'listener', 'How to do nothing and stay happy', 'uk', '0', 1456847364, 1456847364),
(6, 'asdasd', 'Asfdsf CVCXV ASDASd', 'ug', 'asdasd', '2342342342', 'asdasd@sdfsdf.sd', 'sdfsdfsdf', '0', '0', 'asdasdas', 'erwer', 'dccvbcv', '0', 'speaker', 'sadasdasdasd', 'uk', '0', 1457887251, 1457887251);
